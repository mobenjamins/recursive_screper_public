...
def send_email(to_addresses, subject, body, attachments=None):
    ...
    with open(thecozm_logo, "rb") as logo_file:
        ...
        logo_image.add_header('Content-Disposition', 'inline', filename="The Cozm Logo")
